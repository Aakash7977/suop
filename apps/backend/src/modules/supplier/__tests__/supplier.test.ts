...
describe('Supplier RBAC', () => {
  ...
  it('tenant_admin cannot blacklist suppliers (restricted to procurement_manager)', () => { expect(PermissionChecker.hasPermission(['tenant_admin'], Permission.SUPPLIER_BLACKLIST)).toBe(false) })
