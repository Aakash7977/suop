...
CREATE TABLE IF NOT EXISTS "rfqs" (
    ...
    "rfq_type" TEXT NOT NULL DEFAULT 'MULTI_SUPPLIER',
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_tenant_buyer" ON "rfqs"("tenant_id", "buyer_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_tenant_pr" ON "rfqs"("tenant_id", "pr_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_closing" ON "rfqs"("closing_date");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "uq_rfq_tenant_number" ON "rfqs"("tenant_id", "rfq_number");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_line_tenant_rfq" ON "rfq_lines"("tenant_id", "rfq_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_line_tenant_product" ON "rfq_lines"("tenant_id", "product_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_supp_tenant_rfq" ON "rfq_suppliers"("tenant_id", "rfq_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_supp_tenant_supplier" ON "rfq_suppliers"("tenant_id", "supplier_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_rfq_supp_response" ON "rfq_suppliers"("response_status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "uq_rfq_supp_tenant_rfq_supplier" ON "rfq_suppliers"("tenant_id", "rfq_id", "supplier_id");
