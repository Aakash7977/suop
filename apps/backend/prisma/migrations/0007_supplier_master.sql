-- PHASE 5 — SUPPLIER MASTER & VENDOR MANAGEMENT
...
CREATE TABLE IF NOT EXISTS "suppliers" (
    ...
    "total_purchase_value" DECIMAL(14,2),
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "supplier_compliances" (
    "id" UUID NOT NULL,
    "tenant_id" UUID NOT NULL,
    "supplier_id" UUID NOT NULL,
    ...
    CONSTRAINT "supplier_compliances_pkey" PRIMARY KEY ("id")
);
