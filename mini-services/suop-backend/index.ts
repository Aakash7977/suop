...
log('info', `SUOP Backend v${VERSION} started`, { port: PORT, sprint: 40, sprintName: 'Production Execution Mobile Platform & Manufacturing Barcode Scanning App — PART 5 MES (40/48 sprints)' })
