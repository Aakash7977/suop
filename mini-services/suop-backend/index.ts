...
log('info', `SUOP Backend v${VERSION} started`, { port: PORT, sprint: 43, sprintName: 'Machine Integration, Equipment Monitoring & Industrial IoT Foundation — PART 5 MES (43/48 sprints)' })
