  ...
  async fetch(req) {
    ...
    if (path === '/api/production-mobile/dashboard' && method === 'GET') {
      const data = {
        ...
        assignedWorkOrders: [
          { woNumber: 'WO-001', operationNo: 2, operationName: 'Cooking', poNumber: 'PO-2026-00125', productName: 'Kaju Katli 500g', batchNumber: 'KAJ-THN-20260709-000145', plannedQty: 95, actualQty: 0, uom: 'KG', status: 'IN_PROGRESS', startedAt: '2026-07-09T06:35:00Z', machineCode: 'COOK-01', machineName: 'Cooking Kettle 01', recipeCode: 'RCP-KK-001', recipeVersion: 'V2.3' },
          { woNumber: 'WO-002', operationNo: 1, operationName: 'Mixing', poNumber: 'PO-2026-00126', productName: 'Shwet Idli Batter 1kg', batchNumber: null, plannedQty: 100, actualQty: 0, uom: 'KG', status: 'ASSIGNED', startedAt: null, machineCode: 'MIX-02', machineName: 'Mixer 02', recipeCode: 'RCP-IB-002', recipeVersion: 'V1.5' },
          { woNumber: 'WO-003', operationNo: 8, operationName: 'Packaging', poNumber: 'PO-2026-00129', productName: 'Motichoor Laddu 1kg', batchNumber: 'MOT-THN-20260708-000032', plannedQty: 98, actualQty: 0, uom: 'KG', status: 'PENDING', startedAt: null, machineCode: 'PACK-03', machineName: 'Packaging Machine 03', recipeCode: 'RCP-ML-003', recipeVersion: 'V1.2' },
        ],
        machineStatus: [
        ...
        shiftStatus: { shiftCode: 'SHIFT-A', shiftName: 'Morning Shift', startTime: '2026-07-09T06:00:00Z', endTime: '2026-07-09T14:00:00Z', elapsedMinutes: 90, remainingMinutes: 390, breakScheduledAt: '2026-07-09T10:00:00Z', breakDurationMinutes: 30 },
        qualityAlerts: [],
        syncStatus: { isOnline: true, lastSyncAt: new Date().toISOString(), pendingUploads: 0, pendingDownloads: 0, failedSyncs: 0, networkType: 'WIFI', syncHealth: 'HEALTHY' },
        quickActions: [
    ...
    if (path === '/api/production-mobile/work-orders' && method === 'GET') {
      const data = [
        { woNumber: 'WO-001', operationNo: 2, operationName: 'Cooking', poNumber: 'PO-2026-00125', productName: 'Kaju Katli 500g', plannedQty: 95, actualQty: 0, uom: 'KG', status: 'IN_PROGRESS', priority: 'HIGH', startedAt: '2026-07-09T06:35:00Z', machineCode: 'COOK-01', machineName: 'Cooking Kettle 01', recipeCode: 'RCP-KK-001', recipeVersion: 'V2.3', requiredMaterials: [{ materialCode: 'CAS-W320', materialName: 'Cashew W320', plannedQty: 55, uom: 'KG', issued: false, batchRequired: true }, { materialCode: 'SUG-S30', materialName: 'Sugar S30', plannedQty: 35, uom: 'KG', issued: false, batchRequired: true }, { materialCode: 'GHE-COW', materialName: 'Cow Ghee', plannedQty: 4, uom: 'KG', issued: false, batchRequired: true }], qualityChecks: [{ checkType: 'TEMPERATURE', stage: 'COOKING', targetValue: 110, minValue: 108, maxValue: 112, unit: '°C', required: true, completed: false }, { checkType: 'VISUAL', stage: 'COOKING', targetValue: null, minValue: null, maxValue: null, unit: null, required: true, completed: false }] },
        { woNumber: 'WO-002', operationNo: 1, operationName: 'Mixing', poNumber: 'PO-2026-00126', productName: 'Shwet Idli Batter 1kg', plannedQty: 100, actualQty: 0, uom: 'KG', status: 'ASSIGNED', priority: 'NORMAL', startedAt: null, machineCode: 'MIX-02', machineName: 'Mixer 02', recipeCode: 'RCP-IB-002', recipeVersion: 'V1.5', requiredMaterials: [{ materialCode: 'URD-DAL', materialName: 'Urad Dal', plannedQty: 25, uom: 'KG', issued: false, batchRequired: true }, { materialCode: 'RICE', materialName: 'Rice', plannedQty: 75, uom: 'KG', issued: false, batchRequired: true }], qualityChecks: [{ checkType: 'WEIGHT', stage: 'MIXING', targetValue: 100, minValue: 99, maxValue: 101, unit: 'KG', required: true, completed: false }] },
        { woNumber: 'WO-003', operationNo: 8, operationName: 'Packaging', poNumber: 'PO-2026-00129', productName: 'Motichoor Laddu 1kg', plannedQty: 98, actualQty: 0, uom: 'KG', status: 'PENDING', priority: 'NORMAL', startedAt: null, machineCode: 'PACK-03', machineName: 'Packaging Machine 03', recipeCode: 'RCP-ML-003', recipeVersion: 'V1.2', requiredMaterials: [{ materialCode: 'PKG-BOX-1KG', materialName: 'Packaging Box 1kg', plannedQty: 98, uom: 'PCS', issued: false, batchRequired: false }, { materialCode: 'LBL-1KG', materialName: 'Label 1kg', plannedQty: 98, uom: 'PCS', issued: false, batchRequired: false }], qualityChecks: [{ checkType: 'SEAL_VERIFICATION', stage: 'PACKING', targetValue: null, minValue: null, maxValue: null, unit: null, required: true, completed: false }, { checkType: 'WEIGHT', stage: 'PACKING', targetValue: 1, minValue: 0.99, maxValue: 1.01, unit: 'KG', required: true, completed: false }] },
      ]
    ...
    if (path.match(/^\/api\/production-mobile\/work-orders\/[^/]+$/) && method === 'GET') {
      ...
      const data = {
        ...
        requiredMaterials: [
          { materialCode: 'CAS-W320', materialName: 'Cashew W320', plannedQty: 55, uom: 'KG', issued: false, batchRequired: true, availableBatches: [{ batchNumber: 'CAS-THN-20260705-000018', qty: 445, expiry: '2027-01-05', supplier: 'Sri Balaji Cashews' }] },
          { materialCode: 'SUG-S30', materialName: 'Sugar S30', plannedQty: 35, uom: 'KG', issued: false, batchRequired: true, availableBatches: [{ batchNumber: 'SUG-THN-20260701-000042', qty: 965, expiry: '2027-07-01', supplier: 'EID Parry India Ltd' }] },
          { materialCode: 'GHE-COW', materialName: 'Cow Ghee', plannedQty: 4, uom: 'KG', issued: false, batchRequired: true, availableBatches: [{ batchNumber: 'GHE-THN-20260703-000008', qty: 178, expiry: '2027-01-03', supplier: 'Amul Dairy' }] },
        ],
        qualityChecks: [
    ...
    if (path.match(/^\/api\/production-mobile\/work-orders\/[^/]+\/start$/) && method === 'POST') {
      ...
      return new Response(JSON.stringify(successResponse({ woNumber, status: 'IN_PROGRESS', startedAt: new Date().toISOString(), message: `Work order ${woNumber} started` }, `Work order started`)), { headers })
    }
    ...
    if (path.match(/^\/api\/production-mobile\/work-orders\/[^/]+\/pause$/) && method === 'POST') {
      const parts = path.split('/')
      const woNumber = parts[parts.length - 2]
      return new Response(JSON.stringify(successResponse({ woNumber, status: 'PAUSED', pausedAt: new Date().toISOString(), message: `Work order ${woNumber} paused` }, `Work order paused`)), { headers })
    }
    ...
    if (path.match(/^\/api\/production-mobile\/work-orders\/[^/]+\/complete$/) && method === 'POST') {
      ...
      const woNumber = parts[parts.length - 2]
      const body = await request.json()
      return new Response(JSON.stringify(successResponse({ woNumber, status: 'COMPLETED', completedAt: new Date().toISOString(), actualQty: body.actualQty || 95, scrapQty: body.scrapQty || 1, uom: body.uom || 'KG', message: `Work order ${woNumber} completed` }, `Work order completed`)), { headers })
    }
    ...
    if (path === '/api/production-mobile/batch/create' && method === 'POST') {
      ...
      const data = {
        batchNumber, batchType: 'FINISHED_GOODS',
        recipeCode: body.recipeCode, recipeVersion: body.recipeVersion,
        productionOrderNumber: body.productionOrderNumber, workOrderNumber: body.workOrderNumber,
        productSku: body.productSku, productName: body.productName,
        plantCode: body.plantCode || 'THN', plantName: body.plantName || 'Thane Plant',
        productionLineCode: body.productionLineCode, workCenterCode: body.workCenterCode,
        manufacturingDate: new Date().toISOString(),
        expiryDate: body.expiryDate, bestBeforeDate: body.bestBeforeDate,
        actualQty: body.actualQty || 0, uom: body.uom || 'KG',
        status: 'COMPLETED', qualityStatus: 'PENDING',
        labels: [
          { labelCode, labelType: 'PRODUCTION_BATCH', qrCode: 'QR-' + batchNumber, barcodeValue: batchNumber, barcodeType: 'CODE_128', labelData: JSON.stringify({ batchNumber, productName: body.productName, manufacturingDate: new Date().toISOString(), expiryDate: body.expiryDate, recipeVersion: body.recipeVersion, quantity: body.actualQty }) },
          { labelCode: labelCode + '-PALLET', labelType: 'PALLET_LABEL', qrCode: 'QR-' + batchNumber + '-P', barcodeValue: batchNumber + '-P', barcodeType: 'GS1_128', labelData: JSON.stringify({ batchNumber, palletId: 'PAL-' + Math.floor(Math.random() * 9000 + 1000), quantity: body.actualQty, destinationBin: body.destinationBin || 'WH-THN-FG-01/A-01-03-02' }) },
        ],
        printJob: { jobCode: 'LPJ-' + Date.now(), printerType: body.printerType || 'BLUETOOTH', printerName: body.printerName || 'Zebra ZD420', copies: 2, status: 'QUEUED' },
      }
    ...
    if (path === '/api/production-mobile/labels/print' && method === 'POST') {
      const body = await request.json()
      const printDurationMs = 1200 + Math.floor(Math.random() * 600)
      const data = {
        jobCode: 'LPJ-' + Date.now(),
        labelCode: body.labelCode, batchNumber: body.batchNumber,
        printerType: body.printerType || 'BLUETOOTH', printerName: body.printerName || 'Zebra ZD420',
        copies: body.copies || 1, status: 'COMPLETED',
        printStartedAt: new Date().toISOString(),
        printCompletedAt: new Date(Date.now() + printDurationMs).toISOString(),
        printDurationMs, withinTarget: printDurationMs < 2000,
      }
    ...
    if (path === '/api/production-mobile/wip/transfer' && method === 'POST') {
      ...
      const data = {
        ...
        fromWorkCenter: body.fromWorkCenter, toWorkCenter: body.toWorkCenter,
        fromStage: body.fromStage, toStage: body.toStage,
        quantity: body.quantity, uom: body.uom || 'KG',
        operatorCode: body.operatorCode, operatorName: body.operatorName,
        status: 'COMPLETED', transferredAt: new Date().toISOString(),
    ...
    if (path === '/api/production-mobile/quality-check' && method === 'POST') {
      ...
      const data = {
        ...
        workOrderNumber: body.workOrderNumber, batchNumber: body.batchNumber,
        checkType: body.checkType, checkStage: body.checkStage,
        measuredValue: body.measuredValue, targetValue: body.targetValue,
        minValue: body.minValue, maxValue: body.maxValue, unit: body.unit,
        result, remarks: body.remarks,
        checkedBy: body.operatorName, checkedAt: new Date().toISOString(),
        deviceId: body.deviceId, canProceed: result === 'PASS',
      }
    ...
    if (path === '/api/production-mobile/scan' && method === 'POST') {
      const body = await request.json()
      const scanDurationMs = 150 + Math.floor(Math.random() * 100)
      const barcodeValue = body.barcodeValue || ''
      let scanResult: any = {
        scanCode: 'SCAN-' + Date.now(),
        barcodeValue, barcodeType: body.barcodeType || 'CODE_128',
        scanSource: body.scanSource || 'CAMERA',
        scanDurationMs, withinTarget: scanDurationMs < 300,
        scannedAt: new Date().toISOString(),
      }
    ...
    if (path === '/api/production-mobile/sync' && method === 'POST') {
      ...
      const syncDurationMs = 1500 + Math.floor(Math.random() * 1500)
      const data = {
        syncCode: 'PSH-' + Date.now(),
        syncDirection: 'UPLOAD',
        totalTransactions: transactions.length,
        successfulSyncs: transactions.length, failedSyncs: 0, conflictCount: 0,
        syncStartedAt: new Date(Date.now() - syncDurationMs).toISOString(),
        syncCompletedAt: new Date().toISOString(),
        syncDurationMs, withinTarget: syncDurationMs < 10000,
        networkType: 'WIFI', payloadSizeKb: Math.floor(transactions.length * 2.5),
        status: 'COMPLETED',
        results: transactions.map((t: any) => ({ transactionCode: t.transactionCode, status: 'SYNCED', syncedAt: new Date().toISOString() })),
      }
    ...
    if (path.match(/^\/api\/production-mobile\/devices\/[^/]+\/lock$/) && method === 'POST') {
      ...
      return new Response(JSON.stringify(successResponse({ deviceCode, status: 'LOCKED', lockedAt: new Date().toISOString(), message: `Device ${deviceCode} locked remotely` }, `Device locked`)), { headers })
    }
    ...
    if (path.match(/^\/api\/production-mobile\/devices\/[^/]+\/wipe$/) && method === 'POST') {
      const parts = path.split('/')
      const deviceCode = parts[parts.length - 2]
      return new Response(JSON.stringify(successResponse({ deviceCode, status: 'WIPED', wipedAt: new Date().toISOString(), message: `Device ${deviceCode} wiped remotely - all local data erased` }, `Device wiped`)), { headers })
    }
...
log('info', `SUOP Backend v${VERSION} started`, { port: PORT, sprint: 44, sprintName: 'OEE, Production Analytics & Manufacturing Performance Intelligence — PART 5 MES (44/48 sprints)' })
log('info', '🚀 Sprint 44 — OEE, Production Analytics & Manufacturing Performance Intelligence', { sprint: 44, part: 5, tables: 393, oeeResults: 5, kpis: 5, operators: 6, downtimeEvents: 5, heatmaps: 6, executiveSnapshots: 1 })
log('info', 'OEE & Analytics endpoints available (Sprint 44)', { oeeDashboard: 'GET /api/oee/dashboard', oeeCalculate: 'POST /api/oee/calculate', oeeHistory: 'GET /api/oee/history', production: 'GET /api/analytics/production', operators: 'GET /api/analytics/operators', downtime: 'GET /api/analytics/downtime', heatmaps: 'GET /api/analytics/heatmaps', cost: 'GET /api/analytics/cost', executive: 'GET /api/analytics/executive', machine: 'GET /api/analytics/machine', info: 'GET /api/analytics/info' })
log('info', 'Sprint 43 — Machine Integration, Equipment Monitoring & Industrial IoT', { sprint: 43, part: 5, tables: 384, machines: 6, gateways: 3, sensors: 8, alerts: 3, counters: 8, maintenanceTriggers: 5 })
log('info', 'Machine & IoT endpoints available (Sprint 43)', { dashboard: 'GET /api/machines/dashboard', machines: 'GET/POST /api/machines', runtime: 'GET /api/machines/runtime', counters: 'GET /api/machines/counters', maintenance: 'GET /api/machines/maintenance', machineEvent: 'POST /api/machines/:code/event', machineCounter: 'POST /api/machines/:code/counter', machineSensor: 'POST /api/machines/:code/sensor', iotGateways: 'GET /api/iot/gateways', iotSensors: 'GET /api/iot/sensors', info: 'GET /api/machines/info' })
log('info', 'Sprint 42 — Production Costing, Manufacturing Finance & Variance Analysis', { sprint: 42, part: 5, tables: 373, productionCosts: 5, batchCosts: 5, variances: 24, journals: 47, allocations: 30 })
log('info', 'Production costing endpoints available (Sprint 42)', { dashboard: 'GET /api/production-cost/dashboard', costs: 'GET/POST /api/production-cost', recalculate: 'POST /api/production-cost/recalculate', batch: 'GET /api/production-cost/batch/:batchNumber', variances: 'GET /api/production-cost/variances', labor: 'GET /api/production-cost/labor', machine: 'GET /api/production-cost/machine', utility: 'GET /api/production-cost/utility', overhead: 'GET /api/production-cost/overhead', journals: 'GET /api/production-cost/journals', rollup: 'GET /api/production-cost/rollup', info: 'GET /api/production-cost/info' })
log('info', 'Sprint 41 — Packaging, Labeling & Finished Goods Management Engine', { sprint: 41, part: 5, tables: 362, packagingOrders: 5, labelJobs: 5, fgConfirmations: 4, qualityChecks: 9, hierarchyLevels: 4 })
log('info', 'Packaging endpoints available (Sprint 41)', { dashboard: 'GET /api/packaging/dashboard', orders: 'GET/POST /api/packaging/orders', complete: 'POST /api/packaging/orders/:id/complete', hierarchy: 'GET /api/packaging/hierarchy/:orderNumber', labels: 'GET /api/packaging/labels', labelsPrint: 'POST /api/packaging/labels/print', quality: 'GET/POST /api/packaging/quality', finishedGoods: 'GET/POST /api/packaging/finished-goods', handover: 'GET /api/packaging/handover', costs: 'GET /api/packaging/costs', info: 'GET /api/packaging/info' })
log('info', 'Sprint 40 — Production Execution Mobile Platform', { sprint: 40, part: 5, tables: 351, endpoints: 22, loginMethods: 5, qualityChecks: 8, wipStages: 6 })
log('info', 'Production mobile endpoints available (Sprint 40)', { login: 'POST /api/production-mobile/login', register: 'POST /api/production-mobile/register', dashboard: 'GET /api/production-mobile/dashboard', workOrders: 'GET /api/production-mobile/work-orders', materialIssue: 'POST /api/production-mobile/material-issue', batchCreate: 'POST /api/production-mobile/batch/create', labelsPrint: 'POST /api/production-mobile/labels/print', wipTransfer: 'POST /api/production-mobile/wip/transfer', qualityCheck: 'POST /api/production-mobile/quality-check', scan: 'POST /api/production-mobile/scan', sync: 'POST /api/production-mobile/sync', info: 'GET /api/production-mobile/info' })
