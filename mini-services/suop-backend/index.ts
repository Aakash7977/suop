...
log('info', `SUOP Backend v${VERSION} started`, { port: PORT, sprint: 42, sprintName: 'Production Costing, Manufacturing Finance & Variance Analysis Engine — PART 5 MES (42/48 sprints)' })
